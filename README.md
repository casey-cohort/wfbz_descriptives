...
All code has been run and and tested on R version 4.5.3 and Python version 3.13.14 and there are no non-standard hardware requirements. Typical install time is under 1 hour.
...
## Expected output
This codebase outputs the data visualizations of a wildfire burn zone disaster dataset. 
