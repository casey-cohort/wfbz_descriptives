...
# Palette
# 10-color ramp, dark -> light. Applied in order against the alphabetical
# names() bind below. Hardcoded rather than sampled so renders are reproducible
# and match _pop_setup.qmd exactly.
wfbz_ramp <- c(
